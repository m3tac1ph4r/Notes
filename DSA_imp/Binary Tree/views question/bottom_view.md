...
As you can see in the bottom there is one eye. At horizontal distance _0_ there are to nodes but eye can only see the LAST node at horizontal distance 0.
